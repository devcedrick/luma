      ...
      <main className="mx-auto grid w-full max-w-5xl flex-1 grid-cols-1 items-center gap-8 px-4 py-8 lg:grid-cols-2 ">
        ...
        <div className="flex w-full flex-col gap-6">
          {showResults ? (
            ...
            <div className="flex min-h-[380px] w-full flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-border/80 bg-surface/30 p-8 text-center">
